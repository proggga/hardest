...
class TemplateTestCase(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        import hardest
        template = hardest.Template(self.path,
                                    self.context)
    ...
    def test_render(self):
        """Test render content."""
        import hardest
        template = hardest.Template(self.path, self.context)
